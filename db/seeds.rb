...
group_member = GroupsMember.create(group_id: group.id, member_id: member.id)
group_member = GroupsMember.create(group_id: group.id, member_id: member1.id)
group_member = GroupsMember.create(group_id: group.id, member_id: member2.id)
