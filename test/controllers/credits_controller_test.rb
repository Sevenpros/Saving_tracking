...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference("Credit.count") do
      post credits_url, params: { credit: { amount: @credit.amount, interest: @credit.interest, pay_date: @credit.pay_date, status: @credit.status } }, as: :json
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { amount: @credit.amount, interest: @credit.interest, pay_date: @credit.pay_date, status: @credit.status } }, as: :json
    assert_response :success
  end
